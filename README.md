...
<p align="center">
 <img src="assets/screenshot-marketing-hero.png" width="80%" alt="Tumaio Hero Image"/>
</p>
...
|                                           The 360° Dashboard                                           |                                       Spending & Cash Flow Analytics                                       |                                  Strategic "Competitor Rescue" Tool                                  |
| :----------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------: |
|          <img src="assets/screenshot-dashboard-dark.png" width="100%" alt="Tumaio Dashboard">          |            <img src="assets/screenshot-spending-light.png" width="100%" alt="Tumaio Spending">             |        <img src="assets/screenshot-import-transactions.png" width="100%" alt="Tumaio Import">        |
| A high-level command center to see your Net Worth, Cash Flow, and key spending categories at a glance. | Drill-down charts to track your spending habits, identify opportunities, and see your cash flow over time. | A custom-built importer to rescue frustrated users from failing apps like Spendee, Monarch, or Mint. |
...
|                                                      The "Manual-First" Onboarding Hub                                                       |                                                           The Unified Net Worth Engine                                                           |                                                      The "Inflation-Aware" Planning Tool                                                      |
| :------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------: |
|                           <img src="assets/screenshot-add-account-dark.png" width="100%" alt="Tumaio Onboarding">                            |                            <img src="assets/screenshot-wealth-light-mobile.png" width="100%" alt="Tumaio Net Worth">                             |                            <img src="assets/screenshot-spending-plan-dark.png" width="100%" alt="Tumaio Planning">                            |
| The "open-door" to your finances. A "manual-first" system built to connect all assets—from cash and property to CSVs and competitor imports. | The core of the PFM. A multi-currency engine that tracks all assets (bank accounts, property) and debts to give you a true, real-time Net Worth. | This is not a simple budget. This is a goals (Metas) and planning (Orçamento) tool built from the ground up for a high-inflation environment. |
...
1.  **The "US-Centric" Failure:** Modern, powerful apps like **Monarch** are built 100% for the US/EU market. They are unusable as they rely on "open banking" APIs that simply do not exist in some emerging markets.
